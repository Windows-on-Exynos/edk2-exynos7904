...
gGpioBanks[] = {
  ...
  // GPC Banks
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x0060, EFI_PINCTRL_TOP_ADDRESS},
      {1, 0x0080, EFI_PINCTRL_TOP_ADDRESS},
      {2, 0x00A0, EFI_PINCTRL_TOP_ADDRESS}
    }
  },
  ...
  // GPG Banks
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x00C0, EFI_PINCTRL_TOP_ADDRESS},
      {1, 0x00E0, EFI_PINCTRL_TOP_ADDRESS},
      {2, 0x0100, EFI_PINCTRL_TOP_ADDRESS},
      {3, 0x0120, EFI_PINCTRL_TOP_ADDRESS},
      {4, 0x0140, EFI_PINCTRL_TOP_ADDRESS}
    }
  },
  ...
  // GPH Banks
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x0000, EFI_PINCTRL_SHUB_ADDRESS},
      {1, 0x0020, EFI_PINCTRL_SHUB_ADDRESS}
    }
  },
  ...
  // GPP Banks
  {
    ...
    GPIO_BANK_ID_P,
    {
      ...
      {1, 0x0020, EFI_PINCTRL_TOP_ADDRESS},
      {2, 0x0040, EFI_PINCTRL_TOP_ADDRESS}
    }
  },
  ...
  // GPQ Bank
  {
    ...
    {
      // Bank Number, Offset, Pinctrl Address
      {0, 0x0080, EFI_PINCTRL_ALIVE_ADDRESS}
    }
  }
};
