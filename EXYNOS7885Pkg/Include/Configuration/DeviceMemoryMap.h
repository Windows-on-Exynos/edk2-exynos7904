...
*/
	...
	//--------------------- DDR --------------------- */
    {"RAM Partition",            0x80000000, 0x00C00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK_XN},
    ...
    {"RAM Partition",            0x80C50000, 0x0F3B0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"UEFI FD",           		 0x90000000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
    {"RAM Partition",            0x90200000, 0x2BA00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},

    /*Memory hole 0xbbc00000 -> 0xc0000000*/
    {"RAM Partition",            0xC0000000, 0x2C000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"Display Reserved",  		 0xEC000000, 0x0085A000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
    {"RAM Partition",            0xEC85A000, 0x13800000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},

	//--------------------- Register ---------------------
	{"Gic Distributor",    		 0x12301000, 0x00001000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
	{"Gic Redistributors", 		 0x12302000, 0x00006000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
	{"Clock Controller",   		 0x12060000, 0x00001000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
	{"Pinctrl ALIVE",      	 	 0x11CB0000, 0x00001000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
	{"Pinctrl FSYS",       		 0x13430000, 0x00001000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
	{"MMC0", 			   		 0x13500000, 0x00002000, AddDev, MMAP_IO, UNCACHEABLE, MmIO,   DEVICE},
